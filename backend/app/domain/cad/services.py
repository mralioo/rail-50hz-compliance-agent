"""Domain service: apply DwgEditOp edits to a ParsedDrawing in place.

Pure business logic - no I/O, no engine-specific code - so it's testable
without FastAPI and reusable across every CadEnginePort adapter, since it
operates on the engine-agnostic ParsedDrawing (app/domain/cad/ports.py),
not any one engine's I/O.
"""
